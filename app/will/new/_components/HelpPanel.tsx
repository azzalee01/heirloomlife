...
const HELP: Partial<Record<string, HelpItem[]>> = {
  eligibility: [
    ...
    { type: 'tip', title: 'Available nationwide', body: 'Heirloom Wills are available across all Australian states and territories. NSW members can use remote AV witnessing  -  all other states complete with a simple print-and-sign process.' },
  ],
  personal: [
