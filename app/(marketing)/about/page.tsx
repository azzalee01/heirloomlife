    ...
    <>
      ...
      <section style={{ paddingBlock: '5.5rem', background: '#fff', borderTop: '1px solid var(--mkt-line)' }}>
        <div className="md:px-10" style={{ maxWidth: 720, marginInline: 'auto', paddingInline: '1.5rem' }}>
          ...
          <p style={{ marginTop: '3rem', paddingTop: '2rem', borderTop: '1px solid var(--mkt-line)', fontSize: '.85rem', color: 'var(--mkt-stone)' }}>Heirloom Life Pty Ltd · Sydney, NSW · Available across all Australian states and territories.</p>
        </div>
      </section>
