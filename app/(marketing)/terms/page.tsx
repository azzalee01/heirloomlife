...
const sections: LegalSection[] = [
  ...
  },
  {
    ...
    content: <><p>Prices, billing periods and included features are shown before purchase and are in Australian dollars unless stated otherwise. Payments are processed by Stripe. The $129 one-off Will includes three months of Living Vault benefits from purchase. After that period, premium benefits end unless you join the annual membership; you can continue to download and retain your completed Will. The $99 Heirloom Membership includes the Will and renews annually until cancelled. Cancellation stops future renewals and access continues until the end of the paid period unless we tell you otherwise.</p><p>A charity-sponsored Will is available only where you include a positive share for an eligible charity, provide a valid-format ABN and satisfy any conditions shown for the relevant campaign. You remain free to choose the charity and gift share. If you do not want to make a charitable gift, you may keep your saved answers and purchase the standard Will instead.</p><p>Nothing in these terms excludes rights or remedies that cannot lawfully be excluded, including under the Australian Consumer Law. Any refund policy is subject to those rights. Contact <a href="mailto:hello@heirloomlife.com.au">hello@heirloomlife.com.au</a> about billing, cancellation or a service that was not supplied as promised.</p></>,
  },
  {
