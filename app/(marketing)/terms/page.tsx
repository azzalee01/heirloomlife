...
const sections: LegalSection[] = [
  ...
  },
  {
    ...
    // TODO: legal read required before publishing — this is the draft from docs/pricing-update-rollout.md
    content: <><p>Prices, billing periods and included features are shown before purchase and are in Australian dollars, including GST, unless stated otherwise. Payments are processed by Stripe.</p><p>The Will is a one-off payment of $129. It includes your completed Will, permanent access to download it, guided signing and, for NSW addresses, one remote witnessing session. You keep and can download your Will whether or not you buy anything else.</p><p>Unlimited updates is an optional add-on at $25 per year. You can add it when you buy your Will or later. While it is active you can change your Will as many times as you need and download each new version. It renews automatically each year at the price then shown until you cancel, and we will remind you before each renewal. You can cancel at any time from your dashboard. Cancelling stops future renewals, your access continues to the end of the paid period, and you keep your completed Will and its versions.</p><p>Remote witnessing of an updated Will is not yet available. Features described as coming soon are not part of the service until we make them available.</p><p>Nothing in these terms excludes rights or remedies that cannot lawfully be excluded, including under the Australian Consumer Law. Any refund policy is subject to those rights. Contact <a href="mailto:hello@heirloomlife.com.au">hello@heirloomlife.com.au</a> about billing, cancellation or a service that was not supplied as promised.</p></>,
  },
  {
