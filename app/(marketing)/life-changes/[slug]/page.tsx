    ...
    <>
      ...
      <section style={{ paddingBlock: '4rem', background: 'var(--mkt-surface-2)', borderTop: '1px solid var(--mkt-line)' }}>
        <div className="md:px-10" style={{ maxWidth: 1000, marginInline: 'auto', paddingInline: '1.5rem' }}>
          ...
          <p style={{ margin: '.8rem 0 0', maxWidth: '38rem', fontSize: '.9rem', lineHeight: 1.65, color: 'var(--mkt-stone)' }}>Pay $129 once for your Will. Add unlimited updates for $25 a year to keep it current as life changes.</p>
