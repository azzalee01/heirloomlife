    ...
    <>
      <section style={{ background: 'var(--mkt-surface-2)', borderBottom: '1px solid var(--mkt-line)', overflow: 'hidden' }}>
        <div className="relative md:flex md:min-h-[25rem] md:items-center md:px-10" style={{ maxWidth: 1240, marginInline: 'auto', paddingInline: '1.5rem' }}>
          <div className="relative z-10 md:w-[54%]" style={{ paddingBlock: '3.25rem' }}>
            ...
            <h1 style={{ margin: '1.5rem 0 0', maxWidth: '45rem', fontSize: 'clamp(2.6rem, 5.4vw, 4.8rem)', lineHeight: 1.03, fontWeight: 400, color: 'var(--mkt-ink-text)' }}>{event.title}</h1>
      ...
      <section style={{ paddingBlock: '4rem', background: 'var(--mkt-surface-2)', borderTop: '1px solid var(--mkt-line)' }}>
        <div className="md:px-10" style={{ maxWidth: 1000, marginInline: 'auto', paddingInline: '1.5rem' }}>
          ...
          <p style={{ margin: '.8rem 0 0', maxWidth: '38rem', fontSize: '.9rem', lineHeight: 1.65, color: 'var(--mkt-stone)' }}>Pay $129 once for your Will and three months of Vault benefits, or join for $12/month billed annually to keep your Will and estate information supported as this chapter unfolds.</p>
